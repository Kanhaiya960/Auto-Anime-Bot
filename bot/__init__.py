...
class Var:
    ...
    FFCODE_361 = getenv("FFCODE_361") or """ffmpeg -i '{}' -progress '{}' -c:v libaom-av1 -crf 30 -pix_fmt yuv420p -s 640x360 -b:v 150k -c:a libopus -b:a 35k -preset veryfast -metadata title='𝖳𝖦>@Arctix' -metadata author='𝖳𝖦>@Arctix' '{}' -y"""
